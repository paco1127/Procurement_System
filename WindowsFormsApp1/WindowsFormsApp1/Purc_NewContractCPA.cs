...
{
    public partial class Purc_NewContractCPA : Form
    {
        public Purc_NewContractCPA()
        {
            InitializeComponent();
        }
        ...
        private void Purc_NewContractCPA_Load(object sender, EventArgs e)
        {
            DataSet ds = new DataSet();
            string connStr = "Provider = Microsoft.ACE.OLEDB.12.0; " + "Data Source=Database.accdb";
            ...
            string sqlStr4 = "Select ItemID, UOM from ContractLine WHERE ContractID is null";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd1.Parameters.AddWithValue("@Type", "CPA");
